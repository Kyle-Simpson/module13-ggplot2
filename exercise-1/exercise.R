...
ggplot(data = diamonds.sample) +
  geom_histogram(mapping = aes(x = cut, fill = clarity), stat = "count")
...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price), color = "blue", alpha = 5/10) +
  geom_smooth(mapping = aes(x = carat, y = price), color = "black")
